 ...
 * which is accepting for the model.
 * </p>
 * 
 * <p>
...
public class AcceptingModelStatePathChecker {
	 ...
	 * @param interestingDestinationState
	...
	public AcceptingModelStatePathChecker(Set<State> allowedStates,
			...
			Set<State> interestingDestinationState) {
	 ...
	 * least a state which is obtained from an accepting state of the model.
	 * 
	 * @param source
	 *            the source state of interest
	 * @param destination
	 *            the destination state of interest
	 * @return true if the destination state, is reachable from the source
	 *         state, through a path that involves only allowed states and
	 *         crosses at least a state which is obtained from an accepting
	 *         state of the model.
	 * @throws NullPointerException
