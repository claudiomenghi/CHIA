    ...
    for currentClaim=1:claimNumber
        ...
        if(fid==-1)
            ...
            while ischar(tline) 
                ...
                if(strcmp(record(1), '157'))
                    disp(tline);
                    disp(strcmp(record(task1SatisfactionColumn), 'N') && strcmp(record(task3SatisfactionColumn), 'M'))
                end
                ...
                if strcmp(record(task1SatisfactionColumn), 'Y') && strcmp(record(task3SatisfactionColumn), 'M')
                ...
                if strcmp(record(task1SatisfactionColumn), 'N') && strcmp(record(task3SatisfactionColumn), 'M')
