...
public class IntersectionBuilderUpdateIntersectionTest {
	...
	/**
	 * Test method for
	 * {@link it.polimi.checker.intersection.IntersectionBuilder#updateIntersection(State)}
	 * .
	 */
	...
	public void testgetIntersectionStateIllegalStateException() {
		...
		intersectionBuilder.updateIntersection(modelState1, claimState1, 0);
	}
	...
	public void testgetIntersectionStateNullModelState() {
		this.model.addInitialState(modelState1);
		this.model.addBlackBoxState(modelState2);
		this.model.addAcceptState(modelState3);
		this.claim.addInitialState(claimState1);
		...
		intersectionBuilder.updateIntersection(null, claimState1, 0);
	}
	 ...
	 */
	@Test(expected = NullPointerException.class)
	public void testgetIntersectionStateNullClaimState() {
		this.model.addInitialState(modelState1);
		this.model.addBlackBoxState(modelState2);
		this.model.addAcceptState(modelState3);
		this.claim.addInitialState(claimState1);
		...
		IntersectionBuilder intersectionBuilder = new IntersectionBuilder(
				model, claim, AcceptingPolicy.getAcceptingPolicy(
						AcceptingType.BA, this.model, this.claim));
		intersectionBuilder.perform();
		intersectionBuilder.updateIntersection(modelState1, null, 0);
	}
	...
	public void testgetIntersectionStateIllegalArgumentClaimState() {
		this.model.addInitialState(modelState1);
		this.model.addBlackBoxState(modelState2);
		this.model.addAcceptState(modelState3);
		this.claim.addInitialState(claimState1);
		...
		intersectionBuilder.perform();
		intersectionBuilder.updateIntersection(modelState1, new StateFactory().create(), 0);
	}
	 ...
	 */
	@Test(expected = IllegalArgumentException.class)
	public void testgetIntersectionStateIllegalArgumentModelState() {
		this.model.addInitialState(modelState1);
		this.model.addBlackBoxState(modelState2);
		this.model.addAcceptState(modelState3);
		this.claim.addInitialState(claimState1);
		...
		intersectionBuilder.perform();
		intersectionBuilder.updateIntersection(new StateFactory().create(), claimState1, 0);
	}
	 ...
	 */
	@Test(expected = IllegalArgumentException.class)
	public void testgetIntersectionStateIllegalArgumentNumber() {
		this.model.addInitialState(modelState1);
		this.model.addBlackBoxState(modelState2);
		this.model.addAcceptState(modelState3);
		this.claim.addInitialState(claimState1);
		...
		intersectionBuilder.perform();
		intersectionBuilder.updateIntersection(modelState1, claimState1, -1);
	}
	 ...
	 */
	@Test(expected = IllegalArgumentException.class)
	public void testgetIntersectionStateIllegalArgumentNumber2() {
		this.model.addInitialState(modelState1);
		this.model.addBlackBoxState(modelState2);
		this.model.addAcceptState(modelState3);
		this.claim.addInitialState(claimState1);
		...
		intersectionBuilder.perform();
		intersectionBuilder.updateIntersection(modelState1, claimState1, 3);
	}
	...
	public void testUpdateIntersection() {
		...
		State modelState4=new StateFactory().create("7", 7);
		State modelState5=new StateFactory().create("8", 8);
		this.model.addState(modelState4);
		this.model.addState(modelState5);
		
		Set<IGraphProposition> propositions = new HashSet<IGraphProposition>();
		propositions.add(new GraphProposition("a", false));
		this.model.addTransition(modelState4, modelState5, new ModelTransitionFactory().create(propositions));
		this.model.addTransition(modelState5, modelState2, new ModelTransitionFactory().create(propositions));
		this.model.addBlackBoxState(modelState2);
		this.claim.addInitialState(claimState1);
		this.claim.addAcceptState(claimState3);
		IntersectionBuilder intersectionBuilder = new IntersectionBuilder(
		...
		assertEquals(6, intersectionBa.getStates().size());
		intersectionBuilder.updateIntersection(modelState4, claimState1, 0);
		assertEquals(8, intersectionBa.getStates().size());
		
		assertTrue(intersectionBa.isSuccessor(
				intersectionBuilder.getIntersectionState(modelState4, claimState1, 0), 				
				intersectionBuilder.getIntersectionState(modelState5, claimState2, 0)));
		
		assertFalse(intersectionBa.isSuccessor(
				intersectionBuilder.getIntersectionState(modelState5, claimState2, 0), 				
				intersectionBuilder.getIntersectionState(modelState2, claimState3, 0)));
