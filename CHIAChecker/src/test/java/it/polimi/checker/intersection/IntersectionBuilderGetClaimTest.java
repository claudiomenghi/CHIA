...
public class IntersectionBuilderGetClaimTest {
	...
	/**
	 * Test method for
	 * {@link it.polimi.checker.intersection.IntersectionBuilder#getModel()}
	 * .
	 */
	@Test
	public void test() {
		...
		assertTrue(this.claim==new IntersectionBuilder(model, claim, acceptingPolicy).getClaim());
	}
