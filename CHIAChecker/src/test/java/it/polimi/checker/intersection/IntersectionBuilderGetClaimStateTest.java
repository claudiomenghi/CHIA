...
public class IntersectionBuilderGetClaimStateTest {
	/*
	 * Claim
	 */
	private BA claim;
	...
	public void testGetNumberNullArgument() {
		...
		intersectionBuilder.getClaimState(null);
	}
	...
	public void testGetNumberIllegalArgument() {
		...
		intersectionBuilder.perform();
		intersectionBuilder.getClaimState(new StateFactory().create());
	}
	...
	public void testGetNumber() {
		...
		assertEquals(
				...
				claim1State1, intersectionBuilder.getClaimState(intersectionState));
	}
