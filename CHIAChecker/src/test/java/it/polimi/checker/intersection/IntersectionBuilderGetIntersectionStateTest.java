...
public class IntersectionBuilderGetIntersectionStateTest {
	...
	/**
	 * Test method for
	 * {@link it.polimi.checker.intersection.IntersectionBuilder#getIntersectionState(State)}
	 * .
	 */
	...
	public void testgetIntersectionStateIllegalStateException() {
		...
		intersectionBuilder.getIntersectionState(modelState1, claimState1, 0);
	}
	...
	public void testgetIntersectionStateNullModelState() {
		...
		intersectionBuilder.getIntersectionState(null, claimState1, 0);
	}
	...
	public void testgetIntersectionStateNullClaimState() {
		...
		IntersectionBuilder intersectionBuilder = new IntersectionBuilder(
				model, claim, AcceptingPolicy.getAcceptingPolicy(
						AcceptingType.BA, this.model, this.claim));
		intersectionBuilder.perform();
		intersectionBuilder.getIntersectionState(modelState1, null, 0);
	}
	...
	public void testgetIntersectionStateIllegalArgumentClaimState() {
		...
		intersectionBuilder.perform();
		intersectionBuilder.getIntersectionState(modelState1, new StateFactory().create(), 0);
	}
	...
	public void testgetIntersectionStateIllegalArgumentModelState() {
		...
		intersectionBuilder.perform();
		intersectionBuilder.getIntersectionState(new StateFactory().create(), claimState1, 0);
	}
	...
	public void testgetIntersectionStateIllegalArgumentNumber() {
		...
		intersectionBuilder.perform();
		intersectionBuilder.getIntersectionState(modelState1, claimState1, -1);
	}
	...
	public void testgetIntersectionStateIllegalArgumentNumber2() {
		...
		intersectionBuilder.perform();
		intersectionBuilder.getIntersectionState(modelState1, claimState1, 3);
	}
	/**
	 * Test method for
	 * {@link it.polimi.checker.intersection.IntersectionBuilder#getIntersectionState(State)}
	 ...
	 */
	@Test
	public void testgetIntersectionState0() {
		this.model.addInitialState(modelState1);
		this.model.addBlackBoxState(modelState2);
		this.model.addAcceptState(modelState3);
		State modelState4=new StateFactory().create();
	 ...
	 */
	@Test
	public void testgetIntersectionState1() {
		this.model.addInitialState(modelState1);
		this.model.addBlackBoxState(modelState2);
		this.model.addAcceptState(modelState3);
		this.claim.addInitialState(claimState1);
		this.claim.addAcceptState(claimState3);
		State claimState4=new StateFactory().create();
		this.claim.addState(claimState4);
		...
		intersectionBuilder.perform();
		assertEquals(null, 
		intersectionBuilder.getIntersectionState(modelState1, claimState4, 0));
	}
	 ...
	 */
	@Test
	public void testgetIntersectionState2() {
		this.model.addInitialState(modelState1);
		this.model.addBlackBoxState(modelState2);
		this.model.addAcceptState(modelState3);
		this.claim.addInitialState(claimState1);
		this.claim.addAcceptState(claimState3);
		State claimState4=new StateFactory().create();
		this.claim.addInitialState(claimState4);
		...
		intersectionBuilder.perform();
		assertEquals(null, 
		intersectionBuilder.getIntersectionState(modelState1, claimState4, 2));
	}
	 ...
	 */
	@Test
	public void testgetIntersectionState3() {
		this.model.addInitialState(modelState1);
		this.model.addBlackBoxState(modelState2);
		this.model.addAcceptState(modelState3);
		this.claim.addInitialState(claimState1);
