...
public class IntersectionBuilderGetConstrainedTransitionsTest {
	...
	/**
	 * Test method for
	 * {@link it.polimi.checker.intersection.IntersectionBuilder#getConstrainedTransitions(State)}
	 * .
	 */
	@Test(expected = IllegalStateException.class)
	public void testGetConstrainedTransitionsIllegalArgumentState() {
		...
		intersectionBuilder.getConstrainedTransitions(null);
	}
	...
	public void testGetConstrainedTransitionsNullPointer() {
		this.model.addInitialState(modelState1);
		this.model.addBlackBoxState(modelState2);
		this.model.addAcceptState(modelState3);
		this.claim.addInitialState(claimState1);
	...
	public void testGetConstrainedTransitionsIllegalState() {
		this.model.addInitialState(modelState1);
		this.model.addBlackBoxState(modelState2);
		this.model.addAcceptState(modelState3);
		this.claim.addInitialState(claimState1);
		...
		intersectionBuilder.getConstrainedTransitions(new StateFactory().create());
	}
	 ...
	 */
	@Test
	public void testGetConstrainedTransitions() {
		this.model.addInitialState(modelState1);
		this.model.addBlackBoxState(modelState2);
		this.model.addAcceptState(modelState3);
		this.claim.addInitialState(claimState1);
		...
		assertEquals(
				"The state of the model returned corresponds to the state of the model", 2,
				intersectionBuilder.getConstrainedTransitions(modelState2).size());
	}
