...
public class IntersectionBuilderGetModelIntersectionStatesTest {
	...
	/**
	 * Test method for
	 * {@link it.polimi.checker.intersection.IntersectionBuilder#getModelIntersectionStates(State)}
	 * .
	 */
	...
	public void testGetNumberNullArgument() {
		...
		intersectionBuilder.getModelIntersectionStates(null);
	}
	...
	public void testGetNumberIllegalArgument() {
		...
		intersectionBuilder.perform();
		intersectionBuilder.getModelIntersectionStates(new StateFactory().create());
	}
	...
	public void testGetNumber() {
		...
		assertEquals(
				"The state of the model returned corresponds to the state of the model", 1,
				intersectionBuilder.getModelIntersectionStates(model2State1).size());
	}
	...
	public void testGetNumber2() {
		...
		intersectionBuilder.getIntersectionState(
				model2State1, claim1State1, 0);
		assertEquals(
				"The state of the model returned corresponds to the state of the model", 3,
				intersectionBuilder.getModelIntersectionStates(model2State3).size());
	}
