...
public class IntersectionBuilderGetIntersectionStatesTest {
	...
	/**
	 * Test method for
	 * {@link it.polimi.checker.intersection.IntersectionBuilder#getIntersectionStates(State, State)}
	 * .
	 */
	...
	public void testgetIntersectionStateIllegalStateException() {
		...
		intersectionBuilder.getIntersectionStates(modelState1, claimState1);
	}
	...
	public void testgetIntersectionStateNullModelState() {
		...
		intersectionBuilder.getIntersectionStates(null, claimState1);
	}
	...
	public void testgetIntersectionStateNullClaimState() {
		...
		IntersectionBuilder intersectionBuilder = new IntersectionBuilder(
				model, claim, AcceptingPolicy.getAcceptingPolicy(
						AcceptingType.BA, this.model, this.claim));
		intersectionBuilder.perform();
		intersectionBuilder.getIntersectionStates(modelState1, null);
	}
	...
	public void testgetIntersectionStateIllegalArgumentClaimState() {
		...
		intersectionBuilder.perform();
		intersectionBuilder.getIntersectionStates(modelState1, new StateFactory().create());
	}
	...
	public void testgetIntersectionStateIllegalArgumentModelState() {
		...
		intersectionBuilder.perform();
		intersectionBuilder.getIntersectionStates(new StateFactory().create(), claimState1);
	}
	...
	public void testgetIntersectionStateIllegalArgumentNumber() {
		...
		intersectionBuilder.perform();
		assertEquals(1, intersectionBuilder.getIntersectionStates(modelState1, claimState1).size());
	}
	/**
	 * Test method for
	 * {@link it.polimi.checker.intersection.IntersectionBuilder#getIntersectionStates(State, State)}
	...
	public void testgetIntersectionState0() {
		...
		intersectionBuilder.perform();
		assertNotNull( 
		intersectionBuilder.getIntersectionStates(modelState4, claimState1));
	}
	...
	public void testgetIntersectionState1() {
		...
		intersectionBuilder.perform();
		assertEquals(0, 
		intersectionBuilder.getIntersectionStates(modelState1, claimState4).size());
	}
	...
	public void testgetIntersectionState3() {
		...
		intersectionBuilder.perform();
		assertNotNull( 
		intersectionBuilder.getIntersectionStates(modelState1, claimState4));
	}
