...
public class IntersectionBuilderGetClaimIntersectionStatesTest {
	...
	/**
	 * Test method for
	 * {@link it.polimi.checker.intersection.IntersectionBuilder#getClaimIntersectionStates(State)}
	 * .
	 */
	...
	public void testGetNumberNullArgument() {
		...
		intersectionBuilder.getClaimIntersectionStates(null);
	}
	...
	public void testGetNumberIllegalArgument() {
		...
		intersectionBuilder.perform();
		intersectionBuilder.getClaimIntersectionStates(new StateFactory().create());
	}
	...
	public void testGetNumber() {
		...
		assertEquals(
				...
				intersectionBuilder.getClaimIntersectionStates(claimState1).size());
	}
