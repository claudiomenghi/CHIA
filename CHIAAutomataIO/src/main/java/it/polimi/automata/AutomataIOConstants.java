...
public final class AutomataIOConstants {
	...
	public static final String XML_ATTRIBUTE_TRANSITION_ID = "id";
	public static final String XML_ATTRIBUTE_TRANSITION_SOURCE = "source";
	public static final String XML_ATTRIBUTE_TRANSITION_DESTINATION = "destination";
	public static final String XML_ATTRIBUTE_TRANSITION_PROPOSITIONS = "propositions";
	public static final String XML_ATTRIBUTE_INVARIANT = "invariant";

	public static final String XML_ELEMENT_INTERSECTION = "intersection";
	public static final String XML_ELEMENT_BA = "ba";
	public static final String XML_ELEMENT_IBA = "iba";

	public static final String XML_ELEMENT_REACHABILITY_ELEMENT = "reachabilityElement";
	public static final String XML_ELEMENT_REACHABILITY_ELEMENT_SOURCE = "source";
	public static final String XML_ELEMENT_REACHABILITY_ELEMENT_DESTINATION = "destination";
	...
	public static final String CLAIM_PROPOSITIONAL_FORMULA = "("
			+ AutomataIOConstants.SIGMA + ")|((" + AP + ")("
			+ AutomataIOConstants.AND + "(" + AP + "))*)";
	public static final String MODELAP = APREGEX;
	public static final String MODEL_PROPOSITIONS = "((" + MODELAP + ")("
			+ AutomataIOConstants.AND + "(" + MODELAP + "))*)";
	...
	// PATTERN
	// (SIGMA)|((?!)WORD (^(?!)WORD)*)||
	public static final String LABELPATTERN = "^("
			+ AutomataIOConstants.REGEXSIGMA + ")|(\\((?"
			+ AutomataIOConstants.REGEXNOT + ")" + WORD + "("
			+ AutomataIOConstants.REGEXAND + "(?"
			+ AutomataIOConstants.REGEXNOT + ")" + WORD + ")*\\))";
